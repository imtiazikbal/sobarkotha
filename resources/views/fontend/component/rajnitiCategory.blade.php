<!-- national.php -->
  ...
  <div class="mb-3">
    <a class="text-decoration-none" href="{{ route('newsByCategory',['category' => $cRajniti->id]) }}"> 
      <h4 class="pageNameStyle">{{ $cRajniti->cName }}</h4>
    </a>
    <div class="row">
      @foreach ($cRajniti->news as $news)
      ...
      @foreach ($cRajnitiSkip1Take3->news as $news)
    <div class="row">
