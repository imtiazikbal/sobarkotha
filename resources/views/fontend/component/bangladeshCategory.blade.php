<!-- national.php -->
  ...
  <div class="mb-3">
    <a class="text-decoration-none" href="{{ route('newsByCategory',['category' => $cBangladesh->id]) }}"> 
      <h4 class="pageNameStyle">{{ $cBangladesh->cName }}</h4>
    </a>
    <div class="row">
      @foreach ($cBangladesh->news as $news)
    ...
    @foreach ($cBangladeshSkip1Take3->news as $news)
    <div class="row">
